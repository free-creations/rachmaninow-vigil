...
sopranoOneVerseA = \lyricmode {
  Al -- li -- luy -- i -- "a,"
  al -- li -- luy -- i -- "a,"
  al -- li -- luy -- i -- "a."
}

sopranoOneVoiceB = \relative c' {
  \mark #3
  \time 8/4  \skip4*8 \bar ""
...
sopranoOneVoice = {\sopranoOneVoiceA \sopranoOneVoiceB}
sopranoOneVerse = {\sopranoOneVerseA \sopranoOneVerseB} 