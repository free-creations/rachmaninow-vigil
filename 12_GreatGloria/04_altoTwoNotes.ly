...
altoTwoVoice = \relative es' {
  ...
  \time 9/2  bes4 \p\< ces4 des2-- \mp ces4 \p \< des4 es2--\mp des2 \p ~  des4 \! es4 \p es4 \> es4 es1--  \pp  \breathe | \set Staff.currentBarNumber = #24
  ...
  \time 3/2  g4 \mp\> g4 g8 \p [( f8 ]) es4 \< f2 | % 3
  \time 3/2  g4 \mf es4 es4 es4 es4-- \< ( f8 [ g8 ) ]  | % 4
  \time 3/2  as2-- \f \> g2  f2 | % 5
  \time 3/2  g4 \mp bes4 bes4 \<  bes4 bes4 bes4 | % 6
  \time 4/2  as2( \ff ->   g4 f8 [ g8 ) ] as2 ->  ( g4 as8 [ g8 ) ] |
  \time 4/2  f2 \> g2 f1 \breathe | % 8
  ...
  \opage %12
  \time 3/2  g2 \p\> f2 es2 \pp | % 2
  \time 4/4  es4 \p es4 d4-- es8 [( d8 ]) | % 3
  \time 4/4  c4 c4 d4-- es8[( d8 ]) | % 4
  \time 4/4  c8 ( [ d8 ) ] es4 d4 \< ( es4 )| % 5
  \time 4/4  f2-- \mp \> g4 as4   | % 6
  \time 3/2   g2-- \p\> f2--  es2 \pp-- | % 7
  \time 4/4  g2-- \p g2-- |
  \time 4/4  g2-- g2-- |
  \time 4/4  g2-- g4-- \< f8  ( [ g8 ) ]  |
  \time 4/4  as2  \f \> -- g4 as4  |
  \time 3/2  g2--\p\> f2  es2 \pp| % 12
